# -*- coding: utf-8 -*-
"""SAM_no training karachi.ipynb

Automatically generated by Colab.

Original file is located at
    https://colab.research.google.com/drive/1ZMWxIj9mEB6f58YQSqfqoPWmRwwLds5C
"""
...
def get_bounding_box2():
  return [0, 0, 256, 256]

def get_bounding_box(input):
  return [0, 0, 256, 256]
...
# Generate 10 random indices from 80% to 100% of the validation dataset
random_indices = random.sample(range(1, int(len(all_img_patches)*0.19)), 18)
